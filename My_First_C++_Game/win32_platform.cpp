...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd) {
    ...
    // Ensures the window is redrawn horizontally and vertically
    window_class.style = CS_HREDRAW | CS_VREDRAW;
    // Gives a name for the window (Is not seen by the user)
    window_class.lpszClassName = TEXT("Game Window Class");
    // Calls function whenever it needs to send a message when there's an update
    ...
    // Create Window
    HWND window = CreateWindow(window_class.lpszClassName, TEXT("My First Game!"), WS_OVERLAPPEDWINDOW | WS_VISIBLE,
